...
# Bot command menu
# Keep the Telegram command list small. Heavy admin actions stay in /admin/tools.
# Commands not listed here still work when typed manually by the owner.
commands = [
    BotCommand("start", "🎬 Addon link / membership menu"),
    BotCommand("help", "📖 Show clean help guide"),
    BotCommand("status", "🩺 Check runtime / subscription"),
    BotCommand("tools", "🧰 Open Admin Tools panel"),
    BotCommand("set", "🏷️ Attach IMDb metadata"),
    BotCommand("channels", "📡 List source channels"),
    BotCommand("addchannel", "➕ Add source channel/group"),
    BotCommand("removechannel", "➖ Remove source channel/group"),
    BotCommand("log", "📜 Send latest log file"),
