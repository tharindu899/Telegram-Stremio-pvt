...
async def admin_subscriptions_page(request: Request, _: bool = Depends(require_auth)):
    ...
    return templates.TemplateResponse(request, "subscriptions_manage.html", {
        "request": request,
        "theme": theme,
        "themes": get_all_themes(),
        "current_theme": theme_name,
...
async def admin_access_page(request: Request, _: bool = Depends(require_auth)):
    ...
    return templates.TemplateResponse(request, "access_manage.html", {
        "request": request,
        "theme": theme,
        "themes": get_all_themes(),
        "current_theme": theme_name,
...
async def custom_catalogs_page(request: Request, _: bool = Depends(require_auth)):
    ...
    return templates.TemplateResponse(request, "custom_catalogs.html", {
        "request": request,
        "theme": theme,
        "themes": get_all_themes(),
        "current_theme": theme_name,
...
async def subtitle_manage_page(request: Request, _: bool = Depends(require_auth)):
    theme_name = request.session.get("theme", "dark_professional")
    theme = get_theme(theme_name)
    current_user = get_current_user(request)

    return templates.TemplateResponse(request, "subtitle_manage.html", {
        "request": request,
        "theme": theme,
        "themes": get_all_themes(),
        "current_theme": theme_name,
...
async def admin_config_page(request: Request, _: bool = Depends(require_auth)):
    theme_name = request.session.get("theme", "dark_professional")
    theme = get_theme(theme_name)
    current_user = get_current_user(request)
    return templates.TemplateResponse(request, "admin_config.html", {
        "request": request,
        "theme": theme,
        "themes": get_all_themes(),
        "current_theme": theme_name,
...
async def admin_tools_page(request: Request, _: bool = Depends(require_auth)):
    theme_name = request.session.get("theme", "dark_professional")
    theme = get_theme(theme_name)
    current_user = get_current_user(request)
