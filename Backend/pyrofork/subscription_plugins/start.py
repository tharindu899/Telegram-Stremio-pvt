...
LOGGER.debug("subscription start plugin loaded")
...
async def send_start_message(client: Client, message: Message):
    try:
        ...
        LOGGER.debug(f"Subscription bot /start from {user_id}")
        ...
        if not Telegram.SUBSCRIPTION:
            ...
            try:
                ...
                LOGGER.debug(f"Error ensuring token for free user: {e}")
        ...
        LOGGER.error(f"Error in Subscription Bot /start handler: {e}")
